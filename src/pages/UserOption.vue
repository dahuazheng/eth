    ...
    <div id="user-center">
        <div class="user-center__banner">
            <div class="icon-group">
                <img class="logo" src="../assets/images/icon_eth_download.png" alt=""> <span>x</span> <img src="../assets/images/icon_eth_star.png" alt="">
            </div>
            <p>我的</p>
        </div>
...
>>>>>>> be0d8471dff5789e4454a80372a34e11f682e526
    </div>
</template>
